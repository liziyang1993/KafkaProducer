...
import yitian.kafka.producer.monitor.KafkaProperties;
...
public class KafkaOffsetTools {
    ...
    public static void main(String[] args) {
        ...
        String topic = KafkaProperties.KAFKA_TOPIC;
        String broker = KafkaProperties.BROKER_NAME;
        int port = 9092;
        String group = "test";
